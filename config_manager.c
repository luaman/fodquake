...
void ConfigManager_CvarInit(void)
{
	...
	CSTC_Add("cfg_load", NULL, &cstc_cfg_load_get_results, &cstc_cfg_load_get_data, 0, 0);
	CSTC_Add("cfg_save", NULL, &cstc_cfg_load_get_results, &cstc_cfg_load_get_data, 0, 0);
}
