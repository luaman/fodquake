...
#ifdef __GNUC__
#if __GNUC__ > 4 || !(__GNUC__ == 4 && __GNUC_MINOR__ == 6 && __GNUC_PATCHLEVEL >= 2) || (__GNUC__ == 3 && __GNUC_MINOR__ < 3) || (__GNUC__ == 3 && __GNUC_MINOR__ == 3 && __GNUC_PATCHLEVEL__ < 6) || (__GNUC__ == 3 && __GNUC_MINOR__ == 4 && __GNUC_PATCHLEVEL__ < 6)
